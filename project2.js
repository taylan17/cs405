...
class MeshDrawer {
	...
	constructor() {
        ...
        this.ambientColor = [0.2, 0.2, 0.2]; // Adjust as needed
        this.lightDir = [0.85, 0.8, 0.75]; // Should be normalized
	...
	draw(trans) {
        ...
        gl.uniform3fv(this.ambientColorLoc, this.ambientColor);
...
const meshFS = `
		...
		void main()
		{
			...
			vec3 finalColor = texColor.rgb * (ambientColor + diffuse);
